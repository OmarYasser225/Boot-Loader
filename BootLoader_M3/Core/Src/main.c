...
void (*Funtion_Array[12])(uint8_t *Copy_u8buffer) =
    {
        BL_VoidHandleGetVerCmd,
        BL_VoidHandleGetHelpCmd,
        BL_VoidHandleGetCIDCmd,
        BL_VoidHandleGetRDPStatusCmd,
        BL_VoidHandleGoToAddrCmd,
        BL_VoidHandleFlashEraseCmd,
        BL_VoidHandleMemWriteCmd,
        BL_VoidHandleEnRWProtectCmd,
        BL_VoidHandleMemReadCmd,
        BL_VoidHandleReadSectorPStatusCmd,
        BL_VoidHandleOTPRreadCmd,
        BL_VoidHandleDisRWProtectCmd,
    };
